                            ...
                            <div class="is-active" v-if="currentTab === tabs.LOGIN || currentTab === tabs.SIGNUP">
                              ...
                              <div class="columns basic-flex login-fields-container" style="margin-bottom: 0;">
                                <div class="column is-paddingless">
                                  ...
                                  <InputElement type="password" :name="currentTab === tabs.LOGIN ? 'current-password' : 'new-password'" placeholder="password" :autocomplete="currentTab === tabs.LOGIN ? 'current-password' : 'new-password'" v-model="password" :help="passwordHelp.text" @submit="onSubmit">
                                    <template v-slot:leftIcon>
